...
public class Dialog implements Mediator{
    ...
    private final ForgotPasswordButton forgotPasswordButton = new ForgotPasswordButton();
    ...
    public void simulateLoginClicked(){
        loginButton.fireActionPerformed(
                new ActionEvent(this, 0, "login")
        );
    }

    public void simulateForgotPassClicked(){
        forgotPasswordButton.fireActionPerformed(
                new ActionEvent(this, 0, "forgot pass")
        );
    }
}
